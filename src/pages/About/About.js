        ...
        <div>
            <div className="hero-container text-light p-5">
                <div className="container m-md-5 row">
                    ...
                    <p className="lead col-md-6">University of Eastern Africa, E-learning Team</p>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <p className="lead">We're the elearning team <br/>in UEAB </p>
                        </div>
                        <div className="col-md-6">
                            <p>E-learning</p>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-9 bg-secondary">
                            <h3><b>Any E-learning Issues?</b> Feel free to contact us.</h3>
                        </div>
